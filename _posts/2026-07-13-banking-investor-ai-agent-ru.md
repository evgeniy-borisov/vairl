...
Пока не агенты и не LLM. **Основа банковского бизнеса — дисконтированные денежные потоки (DCF) и NPV.**

Именно по NPV (часто рядом с LTV клиента) принимаются решения: кого удерживать, какой продукт предложить, какой риск принять, какой пайплайн строить. Data Lake, Feature Store, скоры, рекомендательные движки, ассистенты в приложении — надстройки над одной первопричиной: *привести будущие деньги клиента к сегодняшней стоимости и максимизировать её для банка*.
