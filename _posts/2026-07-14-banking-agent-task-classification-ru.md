...
*Это вторая часть. Первая — [«Как я собирал инвестиционного агента в банке»](/vairl/blog/2026/07/13/banking-investor-ai-agent-ru/): личный опыт сборки платформы, NPV/DCF, процесс разработки и eval на синтетике + Kaggle.*

На проекте запрос «помоги с инвестициями» без классификатора ломал оркестратор: LLM отвечал на всё, optimizer звали на FAQ. Ниже — как мы размечали задачи.
