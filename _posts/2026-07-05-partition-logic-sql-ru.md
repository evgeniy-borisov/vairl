...
**Логика разбиений** — это не «фича SQL», а базовая конструкция: непересекающиеся классы эквивалентности на множестве строк. В формальной постановке [Дэвида Эллермана](https://www.ellerman.org/) это **вторая фундаментальная математическая логика** — двойственная логике подмножеств. SQL реализует её **трижды** на практике:
