...
> **Материалы для обучения и агента-преподавателя** — развёрнутый перечень дисциплин МФТИ (математика, физика, темы по каждому курсу) и инструкции с маршрутизацией по скиллам-преподавателям:
> [mipt-physmath-fundamentals.txt](/vairl/assets/docs/mipt-physmath-fundamentals.txt) (программа и темы),
> [mipt-teacher-agent-instructions.txt](/vairl/assets/docs/mipt-teacher-agent-instructions.txt) (роутер агента-репетитора, 8 скиллов в `.cursor/skills/teach-*`).
...
- [Физмат-фундамент МФТИ: программа и темы (TXT)](/vairl/assets/docs/mipt-physmath-fundamentals.txt) — 22 дисциплины, перечни тем, связь с агентами
- [Инструкции агента-преподавателя физмата (TXT)](/vairl/assets/docs/mipt-teacher-agent-instructions.txt) — роутер и 8 скиллов `teach-*`
